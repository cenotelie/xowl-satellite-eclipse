...
import org.xowl.infra.denotation.phrases.*;
...
public class GMFDiagramParser implements Parser<Diagram> {
     ...
     * @param signsMap The map of known signs
     */
     ...
     * @param node         The node
     * @param signsMap     The map of known signs
     * @param offsetX      The total offset of this node from the diagram boundary
     * @param offsetY      The total offset of this node from the diagram boundary
     * @param parentWidth  The width of the parent node
     * @param parentHeight The height of the parent node
     */
     ...
     *
     * @param node     The node
     * @param sign     The associated sign
     * @param signsMap The map of known signs
     */
