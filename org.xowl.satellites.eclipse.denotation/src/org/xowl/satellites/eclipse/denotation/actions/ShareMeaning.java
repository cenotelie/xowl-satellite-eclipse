...
public class ShareMeaning implements Runnable {
	...
	private void doRun() throws Exception {
		...
		try (RemotePlatformAccess connection = new RemotePlatformAccess(endpoint, new DeserializerForOSGi())) {
			XSPReply reply = connection.login(login, password);
			if (!reply.isSuccess())
