...
public class DenotationEditor extends MultiPageEditorPart {
    ...
    private class ResourceListener implements IResourceChangeListener {
         ...
         * @param nakedName The naked name for the files of the denotation
         */
     ...
     * @param index The index for the editor
     */
     ...
     *
     * @param file  The denotation file
     * @param index The index for the editor
     */
